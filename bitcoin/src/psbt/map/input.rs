...
/// Type: Previous Transaction ID PSBT_IN_PREVIOUS_TXID = 0x0e
const PSBT_IN_PREVIOUS_TXID: u8 = 0x0e;
/// Type: Output Index PSBT_IN_OUTPUT_INDEX = 0x0f
const PSBT_IN_OUTPUT_INDEX: u8 = 0x0f;
/// Type: Sequence Number PSBT_IN_SEQUENCE = 0x10
const PSBT_IN_SEQUENCE: u8 = 0x10;
/// Type: Required Time Locktime PSBT_IN_REQUIRED_TIME_LOCKTIME = 0x11
const PSBT_IN_REQUIRED_TIME_LOCKTIME: u8 = 0x11;
/// Type: Required Height Locktime PSBT_IN_REQUIRED_HEIGHT_LOCKTIME = 0x12
