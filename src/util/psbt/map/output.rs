...
/// Type: 64 bit integer output's amount in satoshis. PSBT_OUT_AMOUNT = 0x03
const PSBT_OUT_AMOUNT: u8 = 0x03;
/// Type: Script Must be omitted in PSBTv0. Must be provided in PSBTv2. PSBT_OUT_SCRIPT = 0x04
