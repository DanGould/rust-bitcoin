...
/// Type: 32 byte txid PSBT_IN_PREVIOUS_TXID = 0x0e
const PSBT_IN_PREVIOUS_TXID: u8 = 0x0e;
/// Type: Transaction index of the output being spent PSBT_IN_OUTPUT_INDEX = 0x0f
const PSBT_IN_OUTPUT_INDEX: u8 = 0x0f;
/// Type: Sequence number PSBT_IN_SEQUENCE = 0x10
const PSBT_IN_SEQUENCE: u8 = 0x10;
/// Type: Unix timestamp PSBT_IN_REQUIRED_TIME_LOCKTIME = 0x11
const PSBT_IN_REQUIRED_TIME_LOCKTIME: u8 = 0x11;
/// Type: Block height PSBT_IN_REQUIRED_HEIGHT_LOCKTIME = 0x12
